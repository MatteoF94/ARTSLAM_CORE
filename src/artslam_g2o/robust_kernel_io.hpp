#ifndef ARTSLAM_LASER_3D_ROBUST_KERNEL_IO_HPP
#define ARTSLAM_LASER_3D_ROBUST_KERNEL_IO_HPP
...
namespace g2o {
    ...
    bool save_robust_kernels(const std::string& filename, g2o::SparseOptimizer* graph) {
        ...
        for(const auto& edge_ : graph->edges()) {
            g2o::OptimizableGraph::Edge* edge = dynamic_cast<g2o::OptimizableGraph::Edge*>(edge_);
...
#endif //ARTSLAM_LASER_3D_ROBUST_KERNEL_IO_HPP
